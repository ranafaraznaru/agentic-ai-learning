# This file is for basically so we dont have to create index everytime
...
def load_index_run(index_dir: Path, embed_model_name: str):
    # Use HuggingFace embeddings for loading (same as build_vectorstore)
    emb = HuggingFaceEmbeddings(
        model_name="all-MiniLM-L6-v2"
    )
...
def load_or_build_index(
    ...
    embed_model_name: str = "llama-3.3-70b-versatile",
...
def setup_pipeline(pdf_path: str, chunk_size=1000, chunk_overlap=150, embed_model_name="llama-3.3-70b-versatile", force_rebuild=False):
