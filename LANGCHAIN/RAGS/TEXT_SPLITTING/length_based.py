...
splitter = CharacterTextSplitter(
    chunk_size=200,
    chunk_overlap=0, # benift of chunk overlap is it share the word to current and next chunk. Basically it helpful when words cut out, halft word in first chunk and second half in next chunk
    # best chunk_overlap is 10 to 20 percent means if chunk_size is 100 then overlap could be 10 to 20
    separator=''
)
